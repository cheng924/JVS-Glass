...
//    val SERVICE_UUID: UUID = UUID.fromString("00001111-0000-1000-8000-00805F9B34FB")
    val CHARACTERISTIC_UUID: UUID = UUID.fromString("f48a24c1-f69a-11e8-8eb2-f2801f1b9fd1")
//    val CHARACTERISTIC_UUID: UUID = UUID.fromString("00002222-0000-1000-8000-00805F9B34FB")
    val DESCRIPTOR_UUID: UUID = UUID.fromString("f48a24c1-f69a-11e8-8eb2-f2801f1b9fd1")
